...
[DVORAK] = KC_KEYMAP(
    ...
    NO, TAB,  LALT, LCTL, FN1,  LSFT, BSPC, ENT,  SPC,  FN0,  LGUI, LEFT, RGHT, NO  ),
...
[RAISE] = KC_KEYMAP(
    NO, MRWD, MPRV, MPLY, MNXT, MFFD,             F24,  MUTE, VOLD, VOLU, DEL,  NO, \
    NO, TILD, GRV,  LCBR, RCBR, DQUO,             BSLS, EQL,  PLUS, MINS, QUES, NO, \
    NO, ESC,  TAB,  LPRN, RPRN, QUOT,             SLSH, LEFT, DOWN, UP,   RGHT, NO, \
...
[LOWER] = KC_KEYMAP(
    ...
    NO, 1,    2,    3,    4,    5,                6,    7,    8,    9,    0,    NO, \
    NO, FN2,  TRNS, TRNS, TRNS, TRNS,             TRNS, DOT,  TRNS, TRNS, FN3,  NO, \
    NO, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, NO  ),
...
[TERA] = KC_KEYMAP(
    NO, ESC,  4,    5,    6,    7,                F1,   F6,   NLCK, NO,   NO,   NO, \
    NO, 3,    Q,    W,    F,    8,                F2,   F7,   NO,   NO,   NO,   NO, \
    NO, 2,    A,    S,    D,    9,                F3,   F8,   NO,   NO,   NO,   NO, \
    NO, 1,    H,    I,    C,    0,                F4,   F9,   NO,   NO,   NO,   NO, \
    NO, P,    K,    L,    M,    SPC,  SPC,  ENT,  F5,   F10,  NO,   NO,   FN2,  NO  ),

[RESETL] = KEYMAP(
    KC_NO, RESET, KC_NO, KC_NO, KC_NO, KC_NO,               KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,               KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,               KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,               KC_NO, KC_NO, KC_NO, KC_NO, KC_FN3,KC_NO, \
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [2] = ACTION_LAYER_TOGGLE(TERA), // TERA layer
